# Hey welcome today your learning how to insert new user options!
@echo off
...
if %errorlevel%==9 goto tshop
:tshop
cls
echo 1: Mac (+ 100 Bitcoin Clicks Value) (499$)
choice /c 1 /n >nul
if %errorlevel%==1 (
set /a bitcoinclickvalue=%bitcoinclickvalue% + 100
set /a money=%money% - 499
cls
goto btcmine
)
:btcmineru
